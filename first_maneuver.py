...
Delta_v_3 = np.abs(Delta_v_Hohmann1) + np.abs(Delta_v_Hohmann2) # Total Cost of the Hohmann transfer
...
maneuver_data = {
    ...
    'cost_Hohmann_1_km_s': Delta_v_Hohmann1,
    'cost_Hohmann_2_km_s': Delta_v_Hohmann2,
    'Delta_t_3_s_total':     Delta_t_3,
    'Delta_t_preHohmann_s': Delta_t_preHohmann,
    'Delta_t_Hohmann_s':     Delta_t_Hohmann,
    'theta_pre_Hohmann_rad': theta_pre_Hohmann,
    'a_Hohmann_km': a_Hohmann,
    'e_Hohmann':       e_Hohmann,
